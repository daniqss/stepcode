...
1. [Variables](./chapters/variables.html) - Declaration and assignment.
2. [Conditionals](./chapters/conditionals.html) - Making decisions with `if` statements.
3. [Loops](./chapters/loops.html) - Repeating actions with various loop types.
4. [Functions](./chapters/functions.html) - Reusing code with modular blocks.
5. [Usage](./chapters/usage.html) - How to use this tool for your own projects.
