...
1. [Variables](./chapters/1-variables.html) - Declaration and assignment.
2. [Conditionals](./chapters/2-conditionals.html) - Making decisions with `if` statements.
3. [Loops](./chapters/3-loops.html) - Repeating actions with various loop types.
4. [Functions](./chapters/4-functions.html) - Reusing code with modular blocks.
5. [Usage](./chapters/5-usage.html) - How to use this tool for your own projects.
